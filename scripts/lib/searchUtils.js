(function(window) {
    ...
    window._tokenize = function(str) {
    	var cleanStr = removeDiacritics(str.toLowerCase());
        return cleanArray(cleanStr.split(" "));
    }
    
    window._isContainedIn = function(needle, haystack) {
    	var needleTokens = window._tokenize(needle);
        var haystackTokens = window._tokenize(haystack);
